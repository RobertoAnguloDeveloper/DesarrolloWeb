...
<body>
    <div id="listaGastos">
                <table>
                    <tr>
                        <td>
                            <button name="agregarGastoBtn" onclick="window.location.href='agregar.php?agregarGastoBtn';">
                            <img src="../img/add.png" alt="Agregar">
                        </td>
                            
                        <?php if (isset($_SESSION['admin']) && $_SESSION['admin'] == '1') { ?>
                        <td>
                            <button name="listar" onclick="window.location.href='../../controller/ControladorGasto.php?listar=active';">
                            <img src="../img/list.png" alt="Listar">
                        </td>
                        <?php } ?>
                        <form method="post">
                            <td>
