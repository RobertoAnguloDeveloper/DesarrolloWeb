        ...
        public function send() {
            ...
            try {
                ...
                $mail->Body    = "HOLA <br><b>".$this->name."</b></br>".
                                ...
                                "Para ingresar a la plataforma, ingresa a la siguiente dirección: <a href='http://localhost/DesarrolloWeb/index.php'>LOCALHOST</a>";
                
                
                $respuesta = $mail->send();
                $respuesta = (string)$respuesta;
                return "El mensaje ha sido enviado a su correo ".substr($this->to,0,(strlen($this->to)-(3*(strlen($this->to)/2))))."******?".$respuesta;
            } catch (Exception $e) {
